...
class _manageTripScreenState extends State<manageTripScreen> {
  ...
  Future<List<dynamic>> deleteTrips(
    ...
    final url =
        "${baseUrl}/trips/delete-trip/$tripId/$recurring";
    var dio = Dio();
    try {
                          ...
                          child: isError == true
                            ...
                            child: Column(
                              ...
                              separatorBuilder: (context, index) {
                                // print(
                                //     "driver:${tripData[index]["driverName"]}");
                              ...
                              itemBuilder: (context, index) {
                                ...
                                ["tripStatus"] ==
                                  ...
                                  "expectedStartTime"]
                                      ...
                                      ["expectedStartTime"] !=
                                          null) {
                                    DateTime onwardstart1 = DateFormat(
                                        "dd-MM-yyyy HH:mm")
                                ...
                                ["tripStatus"] ==
                                  ...
                                  ["expectedEndTime"]
                                      ...
                                      ["expectedEndTime"] !=
                                          null) {
                                    DateTime onwardend1 = DateFormat(
                                        "dd-MM-yyyy HH:mm")
                                        .parse(dataOfTripsList[index]
                                    ["expectedEndTime"])
                                        .add(const Duration(
                                              ...
                                              'tripStatus'] !=
                                                ...
                                                child: Row(
                                                  ...
                                                  MainAxisAlignment
                                                      .spaceBetween,
                                                  children: [
                                                    dataOfTripsList[index]['tripStatus'] != 'Completed' &&
                                                        ...
                                                        onTap:
                                                          ...
                                                          if (dataOfTripsList[index]["tripStatus"] ==
                                                            ...
                                                            if (dataOfTripsList[index]['expectedStartTime'] != null && dataOfTripsList[index]['expectedStartTime'] != '--') {
                                                              startdate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['expectedStartTime']).add(const Duration(hours: 5, minutes: 30));
                                                              sdate = dateFormat1.format(startdate);
                                                            }
                                                          }
                                                          if (dataOfTripsList[index]["tripStatus"] ==
                                                              "Default") {
                                                            if (dataOfTripsList[index]["actualEndTime"].toString() != "--" && dataOfTripsList[index]["actualEndTime"] != null) {
                                                              DateTime enddate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['actualEndTime']).add(const Duration(hours: 5, minutes: 30));
                                                              edate = dateFormat1.format(enddate);
                                                            ...
                                                            if (dataOfTripsList[index]['expectedEndTime'] != null && dataOfTripsList[index]['expectedEndTime'] != '--') {
                                                              DateTime enddate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['expectedEndTime']).add(const Duration(hours: 5, minutes: 30));
                                                              edate = dateFormat1.format(enddate);
                                                            }
                                                          }
                                                          if (dataOfTripsList[index]['returnStartDateTime'] != null &&
                                                              dataOfTripsList[index]['returnStartDateTime'] != '--') {
                                                            DateTime restartdate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['returnStartDateTime']).add(const Duration(hours: 5, minutes: 30));
                                                            resdate = dateFormat1.format(restartdate);
                                                            // print("resdateis ${resdate}");
                                                          }
                                                          if (dataOfTripsList[index]['returnEndDateTime'] != null &&
                                                              dataOfTripsList[index]['returnEndDateTime'] != '--') {
                                                            DateTime reenddate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['returnEndDateTime']).add(const Duration(hours: 5, minutes: 30));
                                                            reedate = dateFormat1.format(reenddate);
                                                          }
                                                          if (dataOfTripsList[index]['actualStartTime'] != null &&
                                                              dataOfTripsList[index]['actualStartTime'] != '--') {
                                                            DateTime onactualstartdate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['actualStartTime']);
                                                            actualsdate = dateFormat1.format(onactualstartdate);
                                                          }
                                                          if (dataOfTripsList[index]['actualEndTime'] != null &&
                                                              dataOfTripsList[index]['actualEndTime'] != '--') {
                                                            DateTime onactualenddate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['actualEndTime']);
                                                            actualedate = dateFormat1.format(onactualenddate);
                                                          } else {
                                                            actualedate = "---";
                                                          }
                                                          if (dataOfTripsList[index]['returnActualStartTime'] != null &&
                                                              dataOfTripsList[index]['returnActualStartTime'] != '--') {
                                                            DateTime reactualstartdate = DateFormat("dd-MM-yyyy HH:mm").parse(dataOfTripsList[index]['returnActualStartTime']);
                                                            reactualsdate = dateFormat1.format(reactualstartdate);
                                                          }
                                                          if (dataOfTripsList[index]['returnActualEndTime'] != null &&
                                                    ...
                                                    dataOfTripsList[index]['tripStatus'] != 'Completed' &&
                                                        ...
                                                        onTap:
                                                          ...
                                                          showAlertDialog(
                                                              ...
                                                              tripId: dataOfTripsList[index]['tripId'],
                                                              tripName: dataOfTripsList[index]['tripName'],
                                                              recurring: dataOfTripsList[index]['isRecurring'] == "___" ? false : dataOfTripsList[index]['isRecurring']);
                                                          // setState(() {
                                                          //   clickeddeleteButton =
                                                          //       true;
                                                          //   // deleted= false;
                                        ...
                                        children: [
                                          TextButton(
                                              ...
                                              onPressed:
                                                ...
                                                var fromTime = DateFormat('yyyy-MM-dd hh:mm').format(
                                                    DateFormat('dd-MM-yyyy hh:mm')
                                                        .parse(dataOfTripsList[index]["expectedStartTime"]));
                                                fromTime = fromTime + ":00";
                                                dataOfTripsList[index]["expectedStartTime"] = fromTime;
                                                print(
                                                    "tripData[index] : ${dataOfTripsList[index]}");
                                                Navigator.of(
                                                    context)
