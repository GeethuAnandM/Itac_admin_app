...
class _RouteReportsScreenState extends State<RouteReportsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //     .map((Vehiclesnames) =>
    //     VehicleDetailsRep(VehicleId: Vehiclesnames['id'],VehicleName:  Vehiclesnames['name'].toString()))
    //     .toList();
    final _items = widget.vehicleList
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Checkbox(
                          value: selectAll,
                          onChanged: isRouteBtnClicked == true
                              ? null
                              : (bool? val) {
                                  setState(() {
                                    selectAll = val!;
                  ...
                  Container(
                    ...
                    child: SingleChildScrollView(
                      child: DropdownSearch<VehicleDrop>.multiSelection(
                        ...
                        selectedItems: selectAll == true ? Vehicledetails : [],
