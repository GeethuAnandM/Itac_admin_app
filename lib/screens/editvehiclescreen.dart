...
class EditVehicleScreen extends StatefulWidget {
  EditVehicleScreen(
      ...
      required this.vin, required this.detailsforedit}
      );
...
class _EditVehicleScreenState extends State<EditVehicleScreen> {
  ...
  Future<dynamic> editVehicleDetails(
    ...
    print("all device ids from getDeviceCurrentLocation: ${licensePlateNumber}");
    ...
    print("all device ids from deviceIMEIController.text: ${deviceIMEIController.text}");
    ...
    var data = {
      ...
      "orgId": orgId,
      "model": vehiclemodelsIs == 1077979889 ? null : selectedmodelis ?? widget.detailsforedit['VehicleModel'],
      "manufacturerId": manufactureIs ?? widget.detailsforedit['manufacturerId'],
      "modelId": vehiclemodelsIs == 1077979889 ? null : vehiclemodelsIs ?? widget.detailsforedit['modelId'],
...
var addedDeviceid;
  ...
  void initState() {
    () async {
      ...
      insuranceValidityController.text= widget.detailsforedit['insuranceValidity'];
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Container(
                              ...
                              child: DropdownSearch<VehicleDropNew>(
                                popupProps:
                                    PopupProps.bottomSheet(showSearchBox: true,
                                ...
                                dropdownDecoratorProps: DropDownDecoratorProps(
                                  dropdownSearchDecoration: InputDecoration(
                                    labelText: widget.detailsforedit['deviceName'] ??"Select A Device",
                                    hintText: widget.detailsforedit['deviceName'] ?? "Select A Device",
                                    border: new OutlineInputBorder(
                                      borderSide:
                                          new BorderSide(color: Colors.black),
                                      borderRadius: BorderRadius.circular(5.0),
                                ...
                                onChanged: (VehicleDropNew? data) async {
                                  if (data != null) {
                                    setState(() {
                                      ...
                                      deviceIMEIController.text = vehicleNameselected!.imei;
                                      print("newvalue${vehicleNameselected?.id}");
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: DropdownButtonFormField<dynamic>(
                              hint:  Text(widget.detailsforedit['manufacturer'] ??
                            ...
                            child: DropdownButtonFormField<dynamic>(
                              ...
                              onChanged: (dynamic newValue) async {
                                ...
                                if(vehiclemodelsIs.toString().isEmpty){
                                  setState(() {
                                    vehiclemodelsIs = newValue;
                                    print("vehiclemodelsIs fff isss selcted:$vehiclemodelsIs");
                                    print(newValue);
                                  });
                                }
                    ...
                    Container(
                        child: CustomButton(
                            ...
                            onpress: () async {
                              ...
                              print(widget.vehicleid);
                              print("final device idddddd 25 th is: $deviceIdFinal");
                              print(vehicleName);
                    ...
                    CustomButton2(buttontext: "Cancel", onpress: (){
                      Navigator.pop(context);
                    },),
                    SizedBox(
