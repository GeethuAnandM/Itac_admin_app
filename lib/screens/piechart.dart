...
class _PiechartState extends State<Piechart> {
  ...
  Future<String?> getTotaVehicles() async {
    ...
    try {
      ...
      pieData = [
        PieData(
          x: 'Online ${widget.Lists.first.OnlineCount}',
          y: widget.Lists.first.OnlineCount.toDouble(),
          color: Color(0xFF46BEE2),
        ),
        PieData(
            x: 'Offline ${widget.Lists.first.OfflineCount}',
            y: widget.Lists.first.OfflineCount.toDouble(),
