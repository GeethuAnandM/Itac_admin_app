                                                              ...
                                                              child:
                                                                  GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        await getDeviceLists();
                                                                        print(
                                                                            "device type issss that on click second:${widget.vehicleList[index]['vehicleTypeId']}");
                                                                        print(
                                                                            "device id is that:${widget.vehicleList[index]['vehicleTypeName']}");
                                                                        print(
