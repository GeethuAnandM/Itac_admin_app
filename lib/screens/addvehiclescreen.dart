...
class _AddVehicleScreenState extends State<AddVehicleScreen> {
  ...
  Future<dynamic> createVehicleDetails(vehicleName,
      vehicleType,
      licensePlateNumber,
      vin,
      orgId,
    ...
    print("all device ids from deviceIMEIController.text: ${deviceIMEIController
        .text}");
    ...
    var data = {
      ...
      "vin": vin.toString(),
      "model": vehiclemodelsIs == 1077979889 ? null  : selectedmodelis.toString(),
                            ...
                            : CustomButton(
                                ...
                                onpress: () async {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    print("vehcl ei tryoe in iss :$vehicleType");
