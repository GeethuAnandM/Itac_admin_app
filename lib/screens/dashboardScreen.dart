...
class _DashboardState extends State<Dashboard> {
  ...
  getdatas() async {
    ...
    try {
      // print("id is $Id");
      final response =
          await dio.get('${baseUrl}dashboard/trip?userId=$Id');
      // print("hello");
  ...
  getTotaVehicles() async {
    ...
    try {
      final response =
          await dio.get('${baseUrl}dashboard/vehicle-status?userId=${Id}');
      // print(response.data);
      _vehLocationList.clear();
      Lists.clear();
      _vehLocationList.add(response.data);
      // print(response.statusCode.toString());
      if (response.statusCode == 200) {
        // _Lists.add(Pie(
        //   MovingCount: _vehLocationList[0]['movingCount'],
        //   StoppedCount: _vehLocationList[0]['stoppedCount'],
        // ));
        Lists.add(PieChart(
            OnlineCount: _vehLocationList[0]['movingCount'] +
                _vehLocationList[0]['stoppedCount'],
            IdleCount: _vehLocationList[0]['idleCount'],
            MovingCount: _vehLocationList[0]['movingCount'],
            StoppedCount: _vehLocationList[0]['stoppedCount'],
            OfflineCount: _vehLocationList[0]['offlineCount']));
      }
      setState(() {
